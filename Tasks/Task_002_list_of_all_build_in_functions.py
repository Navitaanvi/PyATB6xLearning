...
# print()
print("Navita", "is", "learning", "Python", "Automation", sep="@", end=" with selenium")
...
#sorted
numbers = [23,1, 2, 3, 4,0,2,0,9,86]
print(sorted(numbers))

#reversed
numbers1 = [23,1, 2, 3, 4,0,2,0,9,86]
rev_numbers1 = reversed(numbers1)
print(list(rev_numbers1))
